...
public class Player extends Playable
{
	...
	/**
	 * @return the Clan Contribution points of this Player
	 */
	...
	/**
	 * @return the Clan Contribution total points of this Player
	 */
	...
	/**
	 * Increase the ClanContribution points of this Player (max 100)
	 * @param amount
	 */
	...
	public boolean useMagic(Skill skill, Item item, boolean forceUse, boolean dontMove)
	{
		...
		if (isSkillDisabled(usedSkill))
		{
			...
			if ((getEffectList().getBuffInfoBySkillId(10017) == null) && ((usedSkill.getId() == 10020) || (usedSkill.getId() == 10021)))
			{
				sendPacket(sm);
				return false;
			}
